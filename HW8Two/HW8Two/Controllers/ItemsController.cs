...
namespace HW8Two.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,ItemName,Description,SellerName")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,ItemName,Description,SellerName")] Item item)
        {
            if (ModelState.IsValid)
            {
